<template>
  <div class="flex flex-col bg-neutral-950 items-center min-h-dvh ">
    <div class="h-[80px]"></div>
    <div class="mt-8 flex flex-col items-center justify-end ">
      <h1 class="flex text-white h-auto w-dvw text-6xl justify-center  font-thedark">
        Contact Us
      </h1>
      <h2 class="flex text-white h-auto text-1.5xl w-dvw justify-center  font-loud">
